...
def Start():
    ...
    btn_mining = QPushButton('Mining')
    btn_mining.clicked.connect(QuitAndMining)
    ...
    btn_list = [btn_return2home, btn_launchplanet, btn_getplanet, btn_extentplanet, btn_mining, btn_user1, btn_user2, btn_user3]
    for i in btn_list:
        layout.addWidget(i)
